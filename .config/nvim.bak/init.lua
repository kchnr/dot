...
require("nvim-treesitter.configs").setup({
  ...
  ensure_installed = { "c", "cpp", "go", "lua", "python", "rust", "typescript", "help", "vim", "json" },
...
local null_ls_actions = null_ls.builtins.code_actions
...
null_ls.setup({
  ...
  sources = {
    ...
    null_ls_formatting.black.with({ extra_args = { "--fast" } }),
    null_ls_formatting.stylua,
    null_ls_actions.eslint,
    null_ls_diagnostics.eslint,
  },
